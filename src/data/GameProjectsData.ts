      ...
      <div class="two-col">
        <div class="text">
          ...
          <ul>
            ...
            <li>Challenges the player's mastery of the <strong>Priming</strong> mechanic — the boss has armor layers that must be removed.</li>
            ...
            <li>Tests player <strong>parry/pistol interrupt</strong> skills during an interlude where she repositions and charges an attack that can only be stopped with pistol fire.</li>
            <li>Supports firearm-heavy play: a head weak spot offers high reward for skilled shooters.</li>
      ...
      <div class="two-col">
        <div class="text">
          ...
          <ul>
            ...
            <li>No new animation budget, so I reused two-handed warrior assets and built identity with parryable/unblockable combos and timings.</li>
            <li>Simple early fight, intended to <strong>internalize</strong> parry and pistol interrupt mechanics.</li>
      ...
      <div class="two-col">
        <div class="text">
          ...
          <ul>
            ...
            <li><strong>Priming（下準備）メカニクス</strong>の習熟度を試す戦闘。装甲は層ごとに剥がれ、段階的に難度が上昇。</li>
      ...
      <div class="two-col">
        <div class="text">
          ...
          <ul>
            ...
            <li>早期に登場するためシンプルだが、<strong>パリィとピストル割り込みを身体で覚えさせる</strong>意図がある。</li>
      ...
      <div class="two-col">
        <div class="text">
          ...
          <ul>
            ...
            <li>Act2最初のエリアとして新しい雑魚敵とミニボスを導入し、意図的な難度上昇を演出。</li>
          </ul>
        </div>
        <div class="video">
          <iframe class="youtube" src="https://www.youtube.com/embed/wAJ0A7wfAPE" frameborder="0" allowfullscreen></iframe>
